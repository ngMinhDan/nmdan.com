  ...
  render() {
    return (
      <Html lang={process.env.NEXT_PUBLIC_DEFAULT_LOCALE}>
        <Head>
          <link rel="apple-touch-icon" sizes="76x76" href="/static/favicons/arm.png" />
          <link rel="icon" type="image/png" sizes="32x32" href="/static/favicons/arm.png" />
          <link rel="icon" type="image/jpg" sizes="16x16" href="/static/favicons/hat.jpg" />
          <link rel="manifest" href="/static/favicons/site.webmanifest" />
          <link rel="mask-icon" href="/static/favicons/arm.png" color="#fff" />
