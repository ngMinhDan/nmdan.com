...
After the first post about [mistakes when working with databases](https://nmdan.com/blog/database-postgres-1), I received a lot of positive feedback from my Facebook account and the Design System group. They also provided suggestions on how to write, the content, and how to organize the posts to make them more engaging. I really appreciate those contributions and there will be more specific changes.
